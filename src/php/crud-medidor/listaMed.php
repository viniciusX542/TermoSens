        ...
        <div class="tabela">
            <table>
                <tr class="tabela-titulos">
                    ...
                    <td class="hora-titulo">hora</td>
                    <td class="valor-titulo">temperatura</td>   
                </tr>
                ...
                <?php while (($row = fgetcsv($fp)) !== false) : ?>
                    <tr class="usuarios-lista">
                        ...
                        <td class="hora-usuario"><? $row[2] ?></td>
                        <td class="valr-usuario"><?= $row[1] ?></td>
                        <td>
                        ...
                        <td>
                            <a href="editarMed.php?identificador=<?= $row[0] ?>"><button class="editar-botao">Editar</button></a>
                        </td>
                    </tr>
                <?php endwhile ?>
            </table>
